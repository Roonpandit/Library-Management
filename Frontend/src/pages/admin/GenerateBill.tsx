    ...
    const fetchBorrowDetails = async () => {
      ...
      try {
        ...
        if (borrowData.bookId && typeof borrowData.bookId === "string") {
          const { data: bookData } = await api.get<Book>(
            `/books/${borrowData.bookId}`
          );
          setBook(bookData);
    ...
    return (
      <div className="p-8 bg-white rounded-lg shadow-sm">
        ...
        <div className="p-4 mb-6 text-yellow-700 bg-yellow-100 rounded-md">
          <p>
            This book has not been returned yet. A bill can only be generated
    ...
    <div className="container mx-auto">
      ...
      <div className="p-6 mb-6 bg-white rounded-lg shadow-sm">
            ...
            {book ? (
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  Daily Charge: ${book.chargePerDay.toFixed(2)}
                </p>
              </div>
            ) : (
        ...
        <div className="p-4 bg-gray-50 rounded-md">
          ...
          {borrow.returnDate &&
            new Date(borrow.returnDate) > new Date(borrow.borrowedTill) && (
              <div className="p-3 mb-4 bg-yellow-50 border border-yellow-200 rounded-md">
                ...
                <p className="mt-1 text-sm">
                  ...
                  {returnDate && new Date(borrow.borrowedTill)
                    ? Math.ceil(
                        (returnDate.getTime() -
                          new Date(borrow.borrowedTill).getTime()) /
                          (1000 * 3600 * 24)
                      )
                    : 0}{" "}
                  days late.
          ...
          {generatedBill && (
            <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-md">
              ...
              <div className="mt-2 grid grid-cols-2 gap-2">
                ...
                <p className="font-medium">
                  ${generatedBill.amount.toFixed(2)}
                </p>
                <p className="text-gray-600">Late Fee:</p>
                <p className="font-medium">
                  ${generatedBill.lateFee.toFixed(2)}
                </p>
